...
Мероприятия и События CNCF регулируются Linux Foundation [Кодекс поведения] (https://events.linuxfoundation.org/code-of-conduct/), доступным на странице мероприятий. Он разработан
